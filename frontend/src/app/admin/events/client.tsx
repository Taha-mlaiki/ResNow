        ...
        <div className="space-y-8 p-8 pt-24">
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>View, edit, and publish your events.</CardDescription>
                </CardHeader>
                <CardContent>
                                ...
                                <table className="w-full text-sm">
                                    <thead className="bg-muted/50 border-b">
                                        <tr className="text-left">
                                            ...
                                            <th className="p-4 font-medium text-muted-foreground w-[150px]">Location</th>
                                            <th className="p-4 font-medium text-muted-foreground w-[120px]">Status</th>
                                            <th className="p-4 font-medium text-muted-foreground text-right w-[180px]">Actions</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        {events.map((event) => (
                                            <tr key={event.id} className="border-b last:border-0 hover:bg-muted/5 transition-colors">
                                                ...
                                                <td className="p-4">
                                                    <span className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${event.status === EventStatus.PUBLISHED ? 'bg-green-100 text-green-700' :
                                                            event.status === EventStatus.DRAFT ? 'bg-yellow-100 text-yellow-800' :
